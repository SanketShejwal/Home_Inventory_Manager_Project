...
JButton newButton = new JButton(new ImageIcon("C:\\Users\\HP\\eclipse-workspace\\Home Inventory Manager Project\\bin\\icon\\new file.png"));
JButton deleteButton = new JButton(new ImageIcon("C:\\Users\\HP\\eclipse-workspace\\Home Inventory Manager Project\\bin\\icon\\delete.png"));
JButton saveButton = new JButton(new ImageIcon("C:\\Users\\HP\\eclipse-workspace\\Home Inventory Manager Project\\bin\\icon\\save.png"));
JButton previousButton = new JButton(new ImageIcon("C:\\Users\\HP\\eclipse-workspace\\Home Inventory Manager Project\\bin\\icon\\previous green.png"));
JButton nextButton = new JButton(new ImageIcon("C:\\Users\\HP\\eclipse-workspace\\Home Inventory Manager Project\\bin\\icon\\next green.png"));
JButton printButton = new JButton(new ImageIcon("C:\\Users\\HP\\eclipse-workspace\\Home Inventory Manager Project\\bin\\icon\\printer.png"));
...
exitButton.setIcon(new ImageIcon("C:\\Users\\HP\\eclipse-workspace\\Home Inventory Manager Project\\bin\\icon\\close.png"));
